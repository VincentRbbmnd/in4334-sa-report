...
func main() {
	...
	app := &cobra.Command{
		Use:   "GHCrawler-cli",
		Short: `CLI client for the GHCrawler service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "86.87.235.82:8081", "API hostname")
